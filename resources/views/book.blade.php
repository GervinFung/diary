        ...
        <label for="page-2" class="book__page book__page--4">
            <div class="page__content">
                <div class="account-type-desc-container">
                    ...
                    Record your feelings, emotions, and every happy and sad moments of life that only yourself will know
                    about.
        ...
        <label class="book__page book__page--2">
            <div class="book__page-front">
                <div class="page__content">
                    ...
                    Be perfectly in tune with both your physical and mental state! Keep track of your fitness levels and
                    your moods with our app!
                    <br>
                    <br>
                    <h3 class="book-subtitles">Throwback to Your Happiest Moments</h3>
                    Sometimes, it can be hard to notice the positive changes you’ve been making since they tend to be
                    gradual. Keep track of your progress and notice how far you’ve come. Look back on your entries and
                    where your thoughts were exactly one month ago and beyond.
                    <br>
                    <br>
                    <h3 class="book-subtitles">Don't miss a moment. Get it now!</h3>
                    Take your journal wherever you go with our apps for Linux, Mac, PC, iPhone, iPad, and Android phones
                    & tablets.
                </div>
            </div>
